...
const Login = () => {
    ...
    const handleGoogleError = () => {
        setGoogleError('Google Login was unsuccessful. Try again later.');
    };
            ...
            <div className="container section auth-container">
                <div className="auth-card glass-card animate-fade-in mx-auto">
                    <div className="auth-header text-center mb-6">
                        ...
                        <p className="text-dim">Log in to manage your reservations.</p>
                    </div>

                    {error && <div className="auth-error mb-4">{error}</div>}
                    {googleError && <div className="auth-error mb-4">{googleError}</div>}

                    <div className="google-auth-container mb-6 text-center" style={{ display: 'flex', justifyContent: 'center' }}>
                        <GoogleLogin
                    ...
                    <div className="auth-footer mt-6 text-center text-sm">
                        ...
                        <Link to="/register" className="auth-link text-primary font-bold">Sign Up</Link>
                    </div>
                </div>
            </div>
